...
const Leads = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-4 overflow-x-auto pb-2">
        ...
        <Card className="min-w-[280px] flex-shrink-0">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Leads não arquivados
            </p>
          </CardContent>
        </Card>
      </div>

      {/* Contact Origin Bar Chart (for Leads) */}
      <ContactOriginBarChart
        currentContacts={filteredLeads}
        previousContacts={previousPeriodLeads}
      ...
      {/* Contact County Bar Chart (for Leads) */}
