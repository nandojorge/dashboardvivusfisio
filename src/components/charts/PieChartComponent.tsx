...
interface PieChartComponentProps {
  ...
  previousContacts: Contact[]; // Although not directly used in the pie chart, keeping for consistency if needed later
  selectedPeriod: FilterPeriod;
}

const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#A28DFF', '#FF6666', '#66CC99', '#FFD700', '#ADFF2F', '#8A2BE2'];
...
const PieChartComponent: React.FC<PieChartComponentProps> = ({
  ...
  const getPeriodLabel = (period: FilterPeriod) => {
    switch (period) {
      ...
      case "custom": return "Período Personalizado"; // Assuming custom range is handled elsewhere
