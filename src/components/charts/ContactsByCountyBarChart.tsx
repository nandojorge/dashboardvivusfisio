...
interface ContactsByCountyBarChartProps {
  currentContacts: Contact[];
  selectedPeriod: FilterPeriod;
  dateRange: { from?: Date; to?: Date };
}

const ContactsByCountyBarChart: React.FC<ContactsByCountyBarChartProps> = ({
  currentContacts,
  selectedPeriod,
  dateRange,
}) => {
...
export { ContactsByCountyBarChart };