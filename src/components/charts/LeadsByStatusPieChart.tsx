...
interface LeadsByStatusPieChartProps {
...
const LeadsByStatusPieChart: React.FC<LeadsByStatusPieChartProps> = ({
  currentLeads,
  selectedPeriod,
  dateRange,
}) => {
  ...
  const data = useMemo(() => {
    ...
    currentLeads.forEach(lead => {
      const status = lead.estadodalead || 'Desconhecido';
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Distribuição de leads por estado para {getPeriodLabel(selectedPeriod)}</CardDescription>
      </CardHeader>
